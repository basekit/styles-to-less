...
$siteName = 'YOUR-SITE-NAME'; // For subject line of email to you - will display as 'YourSiteName - Message from Bill Bloggs'
...
$emailFrom = "Glacial Under Construction <hello@emailofmysite.com>";
